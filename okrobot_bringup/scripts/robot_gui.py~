...
table_position = dict()
table_position[0] = (0.309, 0.096, 0.010, 0.000, 0.000, -0.444, 0.896)
table_position[1] = (0.599, 1.03, 0.010, 0, 0, 1.00, -0.020)
table_position[2] = (3.084, -4.097, 0.010, 0.000, 0.000, 0.334, 0.943)
...
#	rospy.loginfo(self.client.get_result())
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "起始点", None))
